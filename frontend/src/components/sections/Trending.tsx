...
const TRENDING_VIDEOS: Record<string, { id: string; title: string; channel: string; duration: string }[]> = {
  'Agentic AI 2025':            [{ id: 'kCc8FmEb1nY', title: 'Agentic AI — The Complete Guide 2025', channel: 'AI Jason', duration: '45 min' }, { id: 'zjkBMFhNj_g', title: 'Building AI Agents from Scratch', channel: 'Fireship', duration: '15 min' }, { id: 'oc6RV5c1yd0', title: 'ReAct Agents Explained', channel: 'LangChain', duration: '20 min' }, { id: 'hfIUstzHs9A', title: 'Multi-Agent Systems with CrewAI', channel: 'Sam Witteveen', duration: '35 min' }, { id: 'wjZofJX0v4M', title: 'LangGraph Agents — Full Tutorial', channel: 'Greg Kamradt', duration: '50 min' }],
  'LLM Models 2025':            [{ id: 'kCc8FmEb1nY', title: 'How Large Language Models Work', channel: 'Andrej Karpathy', duration: '1 hr 56 min' }, { id: 'zjkBMFhNj_g', title: 'GPT-4 vs Claude vs Gemini', channel: 'Fireship', duration: '12 min' }, { id: 'oc6RV5c1yd0', title: 'Llama 3 vs GPT-4 — Which is Better?', channel: 'Matt Wolfe', duration: '15 min' }, { id: 'hfIUstzHs9A', title: 'The State of LLMs in 2025', channel: 'Two Minute Papers', duration: '9 min' }],
  'RAG Tutorial 2025':          [{ id: 'wjZofJX0v4M', title: 'RAG from Scratch — Complete Tutorial', channel: 'Greg Kamradt', duration: '55 min' }, { id: 'kCc8FmEb1nY', title: 'Advanced RAG Techniques 2025', channel: 'LangChain', duration: '40 min' }, { id: 'zjkBMFhNj_g', title: 'RAG vs Fine-Tuning — Which to Use?', channel: 'Fireship', duration: '11 min' }, { id: 'oc6RV5c1yd0', title: 'GraphRAG Tutorial with LlamaIndex', channel: 'AI Jason', duration: '32 min' }],
  'LangGraph Tutorial':         [{ id: 'wjZofJX0v4M', title: 'LangGraph — Build Stateful AI Agents', channel: 'Greg Kamradt', duration: '60 min' }, { id: 'kCc8FmEb1nY', title: 'LangGraph vs LangChain — What Changed?', channel: 'LangChain', duration: '25 min' }, { id: 'zjkBMFhNj_g', title: 'LangGraph in 10 Minutes', channel: 'Fireship', duration: '10 min' }, { id: 'oc6RV5c1yd0', title: 'Multi-Agent Workflows with LangGraph', channel: 'AI Jason', duration: '45 min' }],
  'CrewAI Tutorial 2025':       [{ id: 'oc6RV5c1yd0', title: 'CrewAI — Build Multi-Agent Teams', channel: 'AI Jason', duration: '40 min' }, { id: 'kCc8FmEb1nY', title: 'CrewAI Full Course 2025', channel: 'Sam Witteveen', duration: '90 min' }, { id: 'zjkBMFhNj_g', title: 'CrewAI vs AutoGen vs LangGraph', channel: 'Fireship', duration: '12 min' }],
  'Google Gemini 2.5':          [{ id: 'hfIUstzHs9A', title: 'Gemini 2.5 Pro — Full Review', channel: 'Two Minute Papers', duration: '10 min' }, { id: 'kCc8FmEb1nY', title: 'Building with Gemini API', channel: 'Google Developers', duration: '35 min' }, { id: 'zjkBMFhNj_g', title: 'Gemini 2.5 vs GPT-4o', channel: 'Fireship', duration: '9 min' }],
  'Fine-Tuning LLMs':           [{ id: 'kCc8FmEb1nY', title: 'Fine-Tuning LLMs — Complete Guide 2025', channel: 'Andrej Karpathy', duration: '2 hr' }, { id: 'zjkBMFhNj_g', title: 'LoRA Fine-Tuning Explained', channel: 'Fireship', duration: '13 min' }, { id: 'oc6RV5c1yd0', title: 'QLoRA Tutorial — Fine-Tune on Free GPU', channel: 'AI Jason', duration: '40 min' }],
